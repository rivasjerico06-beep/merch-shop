  ...
  return (
    <AppShell title="Rewards" toasts={toasts}>
      ...
      <section className="mt-6 rounded-[2rem] border border-[#ded0bf] bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
        ...
        <div className="mt-6 h-4 overflow-hidden rounded-full bg-[#eee2d4] dark:bg-white/[0.08]">
          <div
              ...
              <div
                ...
                className={`rounded-3xl border p-5 ${
                  reached
                    ...
                    : "border-[#ded0bf] bg-[#f8efe4] dark:border-white/10 dark:bg-white/[0.05]"
                }`}
              >
      ...
      <section className="mt-6 rounded-[2rem] border border-[#ded0bf] bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
        ...
        <div className="mt-5 space-y-3">
          {coupons.length === 0 ? (
            <div className="rounded-3xl bg-[#f8efe4] p-6 text-center dark:bg-white/[0.05]">
            ...
            coupons.map((coupon) => {
              ...
              return (
                <div
                  key={coupon.id}
                  className="flex flex-col justify-between gap-4 rounded-3xl border border-[#ded0bf] bg-[#f8efe4] p-5 dark:border-white/10 dark:bg-white/[0.05] md:flex-row md:items-center"
                >
                  <div>
                    ...
                    <p className="mt-2 font-mono text-sm font-bold text-violet-600">
                      {coupon.coupon_code}
                    </p>
      ...
      <p className="mt-6 text-center text-xs text-[#725f4d] dark:text-gray-400">
...
function DetailLine({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between gap-3">
      <span className="text-[#725f4d] dark:text-gray-400">{label}</span>
